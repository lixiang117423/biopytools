"""
MethylationAnalyzer模块测试 | MethylationAnalyzer Module Tests
"""
...
from biopytools.methylation_analyzer import MethylationAnalyzerProcessor, MethylationAnalyzerConfig
from biopytools.common.base import ConfigurationError

class TestMethylationAnalyzerConfig:
    ...
    def test_config_creation(self, temp_dir):
        ...
        config = MethylationAnalyzerConfig(
...
class TestMethylationAnalyzerProcessor:
    ...
    def test_processor_creation(self, temp_dir):
        ...
        processor = MethylationAnalyzerProcessor(
            input_dir=str(input_dir),
            output_dir=str(temp_dir / "output")
        )
