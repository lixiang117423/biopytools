"""
MetawrapPipeline模块测试 | MetawrapPipeline Module Tests
"""
...
from biopytools.metawrap_pipeline import MetawrapPipelineProcessor, MetawrapPipelineConfig
from biopytools.common.base import ConfigurationError

class TestMetawrapPipelineConfig:
...
class TestMetawrapPipelineProcessor:
    ...
    def test_processor_creation(self, temp_dir):
        ...
        processor = MetawrapPipelineProcessor(
            input_dir=str(input_dir),
            output_dir=str(temp_dir / "output")
        )
