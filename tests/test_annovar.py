"""
Annovar模块测试 | Annovar Module Tests
"""
...
from biopytools.annovar import AnnovarProcessor, AnnovarConfig
from biopytools.common.base import ConfigurationError

class TestAnnovarConfig:
