"""
AdmixtureToolkit模块测试 | AdmixtureToolkit Module Tests
"""
...
from biopytools.admixture_toolkit import AdmixtureToolkitProcessor, AdmixtureToolkitConfig
from biopytools.common.base import ConfigurationError

class TestAdmixtureToolkitConfig:
...
class TestAdmixtureToolkitProcessor:
    ...
    def test_processor_creation(self, temp_dir):
        ...
        processor = AdmixtureToolkitProcessor(
            input_dir=str(input_dir),
            output_dir=str(temp_dir / "output")
        )
