"""
HaplotypeExtractor模块测试 | HaplotypeExtractor Module Tests
"""
...
from biopytools.haplotype_extractor import HaplotypeExtractorProcessor, HaplotypeExtractorConfig
from biopytools.common.base import ConfigurationError

class TestHaplotypeExtractorConfig:
    ...
    def test_config_creation(self, temp_dir):
        ...
        config = HaplotypeExtractorConfig(
...
class TestHaplotypeExtractorProcessor:
    ...
    def test_processor_creation(self, temp_dir):
        ...
        processor = HaplotypeExtractorProcessor(
            input_dir=str(input_dir),
            output_dir=str(temp_dir / "output")
        )
