"""
GenomeAssembly模块测试 | GenomeAssembly Module Tests
"""
...
from biopytools.genome_assembly import GenomeAssemblyProcessor, GenomeAssemblyConfig
from biopytools.common.base import ConfigurationError

class TestGenomeAssemblyConfig:
...
class TestGenomeAssemblyProcessor:
    ...
    def test_processor_creation(self, temp_dir):
        ...
        processor = GenomeAssemblyProcessor(
            input_dir=str(input_dir),
            output_dir=str(temp_dir / "output")
        )
