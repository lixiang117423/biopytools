"""
EnaDownloader模块测试 | EnaDownloader Module Tests
"""
...
from biopytools.ena_downloader import EnaDownloaderProcessor, EnaDownloaderConfig
from biopytools.common.base import ConfigurationError

class TestEnaDownloaderConfig:
...
class TestEnaDownloaderProcessor:
    ...
    def test_processor_creation(self, temp_dir):
        ...
        processor = EnaDownloaderProcessor(
            input_dir=str(input_dir),
            output_dir=str(temp_dir / "output")
        )
