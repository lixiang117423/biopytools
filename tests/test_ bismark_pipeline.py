"""
 bismarkPipeline模块测试 |  bismarkPipeline Module Tests
"""
...
from biopytools. bismark_pipeline import  bismarkPipelineProcessor,  bismarkPipelineConfig
from biopytools.common.base import ConfigurationError

class Test bismarkPipelineConfig:
...
class Test bismarkPipelineProcessor:
    ...
    def test_processor_creation(self, temp_dir):
        ...
        processor =  bismarkPipelineProcessor(
            input_dir=str(input_dir),
            output_dir=str(temp_dir / "output")
        )
