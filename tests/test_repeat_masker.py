"""
RepeatMasker模块测试 | RepeatMasker Module Tests
"""
...
from biopytools.repeat_masker import RepeatMaskerProcessor, RepeatMaskerConfig
from biopytools.common.base import ConfigurationError

class TestRepeatMaskerConfig:
...
class TestRepeatMaskerProcessor:
    ...
    def test_processor_creation(self, temp_dir):
        ...
        processor = RepeatMaskerProcessor(
            input_dir=str(input_dir),
            output_dir=str(temp_dir / "output")
        )
