"""
MethylationAnalysis模块测试 | MethylationAnalysis Module Tests
"""
...
from biopytools.methylation_analysis import MethylationAnalysisProcessor, MethylationAnalysisConfig
from biopytools.common.base import ConfigurationError

class TestMethylationAnalysisConfig:
    ...
    def test_config_creation(self, temp_dir):
        ...
        config = MethylationAnalysisConfig(
...
class TestMethylationAnalysisProcessor:
    ...
    def test_processor_creation(self, temp_dir):
        ...
        processor = MethylationAnalysisProcessor(
            input_dir=str(input_dir),
            output_dir=str(temp_dir / "output")
        )
