"""
LongestMrna模块测试 | LongestMrna Module Tests
"""
...
from biopytools.longest_mrna import LongestMrnaProcessor, LongestMrnaConfig
from biopytools.common.base import ConfigurationError

class TestLongestMrnaConfig:
...
class TestLongestMrnaProcessor:
