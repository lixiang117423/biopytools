"""
SequenceToolkit模块测试 | SequenceToolkit Module Tests
"""
...
from biopytools.sequence_toolkit import SequenceToolkitProcessor, SequenceToolkitConfig
from biopytools.common.base import ConfigurationError

class TestSequenceToolkitConfig:
...
class TestSequenceToolkitProcessor:
    ...
    def test_processor_creation(self, temp_dir):
        ...
        processor = SequenceToolkitProcessor(
            input_dir=str(input_dir),
            output_dir=str(temp_dir / "output")
        )
