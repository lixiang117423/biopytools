"""
PopgenToolkit模块测试 | PopgenToolkit Module Tests
"""
...
from biopytools.popgen_toolkit import PopgenToolkitProcessor, PopgenToolkitConfig
from biopytools.common.base import ConfigurationError

class TestPopgenToolkitConfig:
...
class TestPopgenToolkitProcessor:
    ...
    def test_processor_creation(self, temp_dir):
        ...
        processor = PopgenToolkitProcessor(
            input_dir=str(input_dir),
            output_dir=str(temp_dir / "output")
        )
