"""
MethylationPipeline模块测试 | MethylationPipeline Module Tests
"""
...
from biopytools.methylation_pipeline import MethylationPipelineProcessor, MethylationPipelineConfig
from biopytools.common.base import ConfigurationError

class TestMethylationPipelineConfig:
    ...
    def test_config_creation(self, temp_dir):
        ...
        config = MethylationPipelineConfig(
...
class TestMethylationPipelineProcessor:
