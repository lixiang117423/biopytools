"""
PacbioSv模块测试 | PacbioSv Module Tests
"""
...
from biopytools.pacbio_sv import PacbioSvProcessor, PacbioSvConfig
from biopytools.common.base import ConfigurationError

class TestPacbioSvConfig:
