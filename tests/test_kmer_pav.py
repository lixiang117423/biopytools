"""
KmerPav模块测试 | KmerPav Module Tests
"""
...
from biopytools.kmer_pav import KmerPavProcessor, KmerPavConfig
from biopytools.common.base import ConfigurationError

class TestKmerPavConfig:
