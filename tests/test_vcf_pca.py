"""
VcfPca模块测试 | VcfPca Module Tests
"""
...
from biopytools.vcf_pca import VcfPcaProcessor, VcfPcaConfig
from biopytools.common.base import ConfigurationError

class TestVcfPcaConfig:
