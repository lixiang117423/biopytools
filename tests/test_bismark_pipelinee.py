"""
BismarkPipelinee模块测试 | BismarkPipelinee Module Tests
"""
...
from biopytools.bismark_pipelinee import BismarkPipelineeProcessor, BismarkPipelineeConfig
from biopytools.common.base import ConfigurationError

class TestBismarkPipelineeConfig:
...
class TestBismarkPipelineeProcessor:
    ...
    def test_processor_creation(self, temp_dir):
        ...
        processor = BismarkPipelineeProcessor(
            input_dir=str(input_dir),
            output_dir=str(temp_dir / "output")
        )
