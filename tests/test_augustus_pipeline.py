"""
AugustusPipeline模块测试 | AugustusPipeline Module Tests
"""
...
from biopytools.augustus_pipeline import AugustusPipelineProcessor, AugustusPipelineConfig
from biopytools.common.base import ConfigurationError

class TestAugustusPipelineConfig:
...
class TestAugustusPipelineProcessor:
    ...
    def test_processor_creation(self, temp_dir):
        ...
        processor = AugustusPipelineProcessor(
            input_dir=str(input_dir),
            output_dir=str(temp_dir / "output")
        )
