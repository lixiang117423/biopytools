"""
NcbiDownloader模块测试 | NcbiDownloader Module Tests
"""
...
from biopytools.ncbi_downloader import NcbiDownloaderProcessor, NcbiDownloaderConfig
from biopytools.common.base import ConfigurationError

class TestNcbiDownloaderConfig:
...
class TestNcbiDownloaderProcessor:
