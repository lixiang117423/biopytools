"""
Minimap2模块测试 | Minimap2 Module Tests
"""
...
from biopytools.minimap2 import Minimap2Processor, Minimap2Config
from biopytools.common.base import ConfigurationError

class TestMinimap2Config:
