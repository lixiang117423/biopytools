...
class ResultsManager:
        ...
        for assembly_type, fasta_list in assembly_files.items():
            ...
            for fasta_file in fasta_list:
                ...
                if not final_path.exists():
                    ...
                    self.logger.info(f" 复制组装文件|Copying assembly file: {file_path.name}")
                ...
                for file_type, file_path in files.items():
                    if os.path.exists(file_path):
                        ...
                        if not final_path.exists():
                            ...
                            self.logger.info(f" 复制挂载文件|Copying scaffold file: {new_name}")
    ...
    def _summarize_quality_results(self, quality_results: Dict[str, Dict[str, Any]]) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.warning(f" 质量结果汇总失败|Quality results summarization failed: {e}")
    ...
    def _generate_recommendations(self, quality_results: Dict[str, Dict[str, Any]], summary: Dict[str, Any]) -> List[str]:
        ...
        try:
            ...
            self.logger.warning(f" 建议生成失败|Recommendation generation failed: {e}")
    ...
    def _save_results_json(self, final_results: Dict[str, Any]):
        ...
        try:
            ...
            self.logger.info(f" JSON结果摘要已保存|JSON results summary saved: {json_file}")
        except Exception as e:
            self.logger.warning(f" JSON保存失败|JSON save failed: {e}")
    ...
    def _create_readme_file(self, final_results: Dict[str, Any]):
        ...
        self.logger.info(f" README文件已创建|README file created: {readme_file}")
