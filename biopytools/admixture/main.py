    ...
    def run_analysis(self):
        ...
        try:
            ...
            if self.config.skip_preprocessing:
                self.logger.info("\n跳过质量控制步骤 - 使用已预处理的数据 | Skipping quality control steps - using pre-processed data")
            ...
            # 修复 #2: 在ADMIXTURE分析前修复染色体编号 | Fix chromosome codes before ADMIXTURE
            self.logger.info("\n修复染色体编号 | Fixing chromosome codes")
