...
功能: 基因组/转录组/蛋白质序列的BUSCO质量评估完整流程，支持批处理和结果汇总 | 
Features: Complete pipeline for BUSCO quality assessment of genome/transcriptome/protein sequences, supporting batch processing and result summarization
作者 | Author: Claude  
