    ...
    def generate_analysis_summary(self, stats_results: dict):
        ...
        with open(summary_file, 'w', encoding='utf-8') as f:
            ...
            if stats_results:
                ...
                # 找出异常样本 | Identify outlier samples
                f.write("潜在异常样本 | Potential Outlier Samples:\n")
                ...
                if high_het_samples:
                    f.write(f"  高杂合率样本 (>0.7) | High heterozygosity samples: {', '.join(high_het_samples[:5])}{'...' if len(high_het_samples) > 5 else ''}\n")
