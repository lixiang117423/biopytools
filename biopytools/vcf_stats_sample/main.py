...
class VCFStatsAnalyzer:
    ...
    def run_analysis(self):
        ...
        try:
            ...
            self.logger.info("📋 步骤 1/3: 处理VCF文件 | Step 1/3: Processing VCF file")
            ...
            self.logger.info("📈 步骤 2/3: 计算统计结果 | Step 2/3: Calculating statistics")
            ...
            self.logger.info("💾 步骤 3/3: 导出结果 | Step 3/3: Exporting results")
