"""
 BWA-GATK流程配置管理模块|BWA-GATK Pipeline Configuration Management Module
"""
...
class PipelineConfig:
    ...
    qc_unqualified_percent: int = 40  # 不合格碱基百分比|Unqualified base percentage
    qc_n_base_limit: int = 10  # N碱基数量限制|N base count limit
    qc_read1_suffix: Optional[str] = None  # R1文件后缀|R1 file suffix
    ...
    clean_fastq_dir: str = field(init=False)
