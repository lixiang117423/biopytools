...
class AlignConfig:
    ...
    # 🧬 BWA mem 算法参数 | BWA mem algorithm parameters
    ...
    # 📊 BWA mem 打分参数 | BWA mem scoring parameters
    ...
    # 🔍 BWA mem 输入输出参数 | BWA mem I/O parameters
    ...
    def validate(self):
        ...
        if self.step_size > self.window_size:
            errors.append(f"⚠️  步长大于窗口大小，将产生不连续的窗口 | Step > window size will create gaps")
