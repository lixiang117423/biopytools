...
class ResultsManager:
    ...
    def parse_raxml_info(self) -> Dict[str, str]:
        ...
        if not info_file.exists():
            self.logger.warning(" RAxML信息文件未找到|RAxML info file not found")
            return {}
        ...
        try:
            ...
            self.logger.warning(f" 解析信息文件失败|Failed to parse info file: {e}")
            ...
            try:
                with open(best_tree_file, 'r') as f:
                    ...
                    if tree_content and tree_content.endswith(';'):
                        ...
                        self.logger.warning(" 最佳树文件可能格式不正确|Best tree file may have incorrect format")
            except Exception as e:
