"""
KEGG pathway 静态映射表|KEGG pathway static map
由 build_kegg_pathway_map.py 自动生成|Auto-generated by build_kegg_pathway_map.py
生成时间|Generated: 2026-07-21 12:18:14
来源|Source: KEGG REST API (list/pathway/ko)
条目|Entries: 503 (仅 name; category 需本地补全|name only; category needs local fill)
结构|Schema: ko_id -> (name, category_A)
说明|Note: category_A 可能为空(Optional); 本地重跑可补全
"""

# ko_id: (name, category_A[Motabolism等7大类, 可空])
KEGG_PATHWAY = {
    ...
    'ko04519': ('Cadherin signaling', ''),
    'ko04144': ('Endocytosis', ''),
    'ko04145': ('Phagocytosis', ''),
    'ko04142': ('Lysosome biogenesis', ''),
    'ko04146': ('Peroxisome', ''),
    'ko04149': ('Peroxisome - yeast', ''),
    ...
    'ko04156': ('Integrated stress response (ISR) signaling pathway', ''),
    ...
    'ko04666': ('Fc gamma R-mediated phagosome formation', ''),
