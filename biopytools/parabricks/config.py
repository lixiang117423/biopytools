# """
# ⚙️ parabricks WGS分析配置管理模块 | parabricks WGS Analysis Configuration Management Module ⚙️
# """
...
#     # ⚙️ parabricks参数 | parabricks parameters
#     parabricks_path: str = "/share/apps/containers/parabricks.sif"
#     threads: int = 88
