"""
Fastq到VCF (Parabricks) 工具模块|Fastq to VCF (Parabricks) Utilities Module
"""
...
class Fastq2VcfLogger:
    """Fastq到VCF日志管理器|Fastq to VCF Logger Manager"""

    def __init__(self, log_dir: str, log_name: str = "pipeline.log", log_level: str = 'INFO',
        ...
        self.logger = logging.getLogger(f"fastq2vcf_parabricks_{timestamp}")
