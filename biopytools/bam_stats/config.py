...
class BAMStatsConfig:
    """BAM统计分析配置类 ⚙️ | BAM Statistics Analysis Configuration Class"""
    ...
    def __init__(self, **kwargs):
        ...
        self.window_size: int = kwargs.get('window_size', 1000000)  # 1M窗口大小
        self.step_size: int = kwargs.get('step_size', 100000)      # 100kb步长
        ...
        self.max_workers: int = kwargs.get('max_workers', min(self.threads, 16))  # 限制并发样品数
