...
COMMAND_REGISTRY = [
    ...
    # ('merge_deepbsa', 'merge-deepbsa', '合并Windows版DeepBSA结果|Merge Windows DeepBSA results'),
    ...
    ('annorefine', 'annorefine', '注释精修(同源补漏+合并拆分+ORF/表达质控)|Annotation refinement (homology gap-fill + split + QC)'),
    ('braker4ps', 'braker4ps', 'braker+annorefine端到端(注释+查漏补缺)|braker + gap-filling end-to-end'),
