"""
VcfPcaCLI命令 | VcfPca CLI Command
"""
...
@click.pass_context
def vcf_pca(ctx, input_dir, output_dir, threads):
    """VcfPca工具 | VcfPca Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-vcf_pca', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
