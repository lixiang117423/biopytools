"""
FindCncbLinkCLI命令 | FindCncbLink CLI Command
"""

import click
from ...find_cncb_link.main import main as find_cncb_link_main
...
@click.pass_context
def find_cncb_link(ctx, input_dir, output_dir, threads):
    """FindCncbLink工具 | FindCncbLink Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-find_cncb_link', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
