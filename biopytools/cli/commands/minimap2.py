"""
Minimap2CLI命令 | Minimap2 CLI Command
"""
...
@click.pass_context
def minimap2(ctx, input_dir, output_dir, threads):
    """Minimap2工具 | Minimap2 Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-minimap2', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
