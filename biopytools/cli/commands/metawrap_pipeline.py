"""
MetawrapPipelineCLI命令 | MetawrapPipeline CLI Command
"""

import click
from ...metawrap_pipeline.main import main as metawrap_pipeline_main
...
@click.pass_context
def metawrap_pipeline(ctx, input_dir, output_dir, threads):
    """MetawrapPipeline工具 | MetawrapPipeline Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-metawrap_pipeline', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
