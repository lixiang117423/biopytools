"""
GenomeAssemblerCLI命令 | GenomeAssembler CLI Command
"""

import click
from ...genome_assembler.main import main as genome_assembler_main
...
@click.pass_context
def genome_assembler(ctx, input_dir, output_dir, threads):
    """GenomeAssembler工具 | GenomeAssembler Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-genome_assembler', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
