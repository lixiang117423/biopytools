"""
RepeatMaskerCLI命令 | RepeatMasker CLI Command
"""

import click
from ...repeat_masker.main import main as repeat_masker_main
...
@click.pass_context
def repeat_masker(ctx, input_dir, output_dir, threads):
    """RepeatMasker工具 | RepeatMasker Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-repeat_masker', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
