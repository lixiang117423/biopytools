"""
PlinkCLI命令 | Plink CLI Command
"""

import click
from ...plink.main import main as plink_main
...
@click.pass_context
def plink(ctx, input_dir, output_dir, threads):
    """Plink工具 | Plink Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-plink', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
