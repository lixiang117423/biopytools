"""
KmerPavCLI命令 | KmerPav CLI Command
"""

import click
from ...kmer_pav.main import main as kmer_pav_main
...
@click.pass_context
def kmer_pav(ctx, input_dir, output_dir, threads):
    """KmerPav工具 | KmerPav Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-kmer_pav', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
