"""
ExamplesCLI命令 | Examples CLI Command
"""

import click
from ...examples.main import main as examples_main
...
@click.pass_context
def examples(ctx, input_dir, output_dir, threads):
    """Examples工具 | Examples Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-examples', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
