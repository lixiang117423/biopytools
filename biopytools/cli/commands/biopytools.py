"""
BiopytoolsCLI命令 | Biopytools CLI Command
"""

import click
from ...biopytools.main import main as biopytools_main
...
@click.pass_context
def biopytools(ctx, input_dir, output_dir, threads):
    """Biopytools工具 | Biopytools Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-biopytools', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
