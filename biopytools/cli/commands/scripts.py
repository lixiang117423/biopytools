"""
ScriptsCLI命令 | Scripts CLI Command
"""

import click
from ...scripts.main import main as scripts_main
...
@click.pass_context
def scripts(ctx, input_dir, output_dir, threads):
    """Scripts工具 | Scripts Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-scripts', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
