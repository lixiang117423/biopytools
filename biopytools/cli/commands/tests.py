"""
TestsCLI命令 | Tests CLI Command
"""

import click
from ...tests.main import main as tests_main
...
@click.pass_context
def tests(ctx, input_dir, output_dir, threads):
    """Tests工具 | Tests Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-tests', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
