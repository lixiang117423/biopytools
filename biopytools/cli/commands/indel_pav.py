"""
IndelPavCLI命令 | IndelPav CLI Command
"""

import click
from ...indel_pav.main import main as indel_pav_main
...
@click.pass_context
def indel_pav(ctx, input_dir, output_dir, threads):
    """IndelPav工具 | IndelPav Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-indel_pav', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
