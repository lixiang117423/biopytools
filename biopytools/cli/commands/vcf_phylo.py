"""
VcfPhyloCLI命令 | VcfPhylo CLI Command
"""
...
@click.pass_context
def vcf_phylo(ctx, input_dir, output_dir, threads):
    """VcfPhylo工具 | VcfPhylo Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-vcf_phylo', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
