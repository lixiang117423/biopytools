"""
EmmaxCLI命令 | Emmax CLI Command
"""

import click
from ...emmax.main import main as emmax_main
...
@click.pass_context
def emmax(ctx, input_dir, output_dir, threads):
    """Emmax工具 | Emmax Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-emmax', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
