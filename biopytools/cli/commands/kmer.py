"""
KmerCLI命令 | Kmer CLI Command
"""

import click
from ...kmer.main import main as kmer_main
...
@click.pass_context
def kmer(ctx, input_dir, output_dir, threads):
    """Kmer工具 | Kmer Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-kmer', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
