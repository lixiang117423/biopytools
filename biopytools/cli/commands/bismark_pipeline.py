"""
BismarkPipelineCLI命令 | BismarkPipeline CLI Command
"""

import click
from ...bismark_pipeline.main import main as bismark_pipeline_main
...
@click.pass_context
def bismark_pipeline(ctx, input_dir, output_dir, threads):
    """BismarkPipeline工具 | BismarkPipeline Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-bismark_pipeline', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
