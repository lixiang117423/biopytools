"""
LongestMrnaCLI命令 | LongestMrna CLI Command
"""
...
@click.pass_context
def longest_mrna(ctx, input_dir, output_dir, threads):
    """LongestMrna工具 | LongestMrna Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-longest_mrna', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
