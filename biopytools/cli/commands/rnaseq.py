"""
RnaseqCLI命令 | Rnaseq CLI Command
"""
...
@click.pass_context
def rnaseq(ctx, input_dir, output_dir, threads):
    """Rnaseq工具 | Rnaseq Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-rnaseq', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
