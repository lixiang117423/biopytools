"""
VcfFilterCLI命令 | VcfFilter CLI Command
"""
...
@click.pass_context
def vcf_filter(ctx, input_dir, output_dir, threads):
    """VcfFilter工具 | VcfFilter Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-vcf_filter', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
