"""
SeqExtractorCLI命令 | SeqExtractor CLI Command
"""

import click
from ...seq_extractor.main import main as seq_extractor_main
...
@click.pass_context
def seq_extractor(ctx, input_dir, output_dir, threads):
    """SeqExtractor工具 | SeqExtractor Tool"""
    import sys
    
    # 构建参数列表 | Build argument list
    args = ['biopytools-seq_extractor', '-i', input_dir, '-o', output_dir, '-t', str(threads)]
