        ...
        if success:
            ...
            if expected_lib.exists():
                ...
                if possible_libs:
                    ...
                    self.logger.warning(f" 使用找到的LTR库文件|Using found LTR library file: {self.output_lib}")
                else:
                    self.logger.warning(" 未找到LTR_retriever库文件|LTR_retriever library file not found")
