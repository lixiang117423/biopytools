"""
GATK Joint Genotyping 工具函数模块 | GATK Joint Genotyping Utility Functions Module
"""
...
class JointLogger:
    """Joint Genotyping 日志管理器 | Joint Genotyping Logger Manager"""
    
    def __init__(self, output_dir: Path, log_name: str = "joint_genotyping.log"):
