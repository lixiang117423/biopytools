"""
GATK Joint Genotyping主程序模块|GATK Joint Genotyping Main Module
"""
...
class GATKJointGenotyper:
    """GATK Joint Genotyping主类|Main GATK Joint Genotyping Class"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='GATK Joint Genotyping脚本(模块化版本)|GATK Joint Genotyping Script (Modular Version)',
...
示例|Examples:
  %(prog)s -i gvcf_folder/ -r ref.fasta -o results/
    ...
    parser.add_argument('-o', '--output-dir', default='./joint_genotyping_output',
