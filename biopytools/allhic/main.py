...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='ALLHiC Pipeline v5.4 (Asmkit版本) - Hi-C基因组支架构建工具|ALLHiC Pipeline v5.4 (Asmkit Edition) - Hi-C Genome Scaffolding Tool',
...
示例|Examples:
  %(prog)s -r draft.asm.fasta -1 reads_R1.fastq.gz -2 reads_R2.fastq.gz -k 12
    ...
    parser.add_argument('-e', '--enzyme', default="GATC",
                       help='ALLHiC酶切位点|ALLHiC enzyme motif')
    ...
    parser.add_argument('--skip-extract', action='store_true',
                       help='跳过步骤3.5: 矩阵提取|Skip Step 3.5: Extract Matrix')
    ...
    parser.add_argument('--skip-build', action='store_true',
                       help='跳过步骤6: 构建|Skip Step 6: Build FASTA')
    parser.add_argument('--skip-plot', action='store_true',
                       help='跳过步骤7: 绘图|Skip Step 7: Plot Heatmap')
