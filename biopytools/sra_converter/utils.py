...
def check_dependencies(config, logger):
    ...
    try:
        ...
        logger.warning(f"⚠️  parallel-fastq-dump 未找到 | not found")
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            if not parallel_available:
                ...
                logger.warning(f"⚠️  将使用fastq-dump (速度较慢) | Will use fastq-dump (slower)")
    except (subprocess.TimeoutExpired, FileNotFoundError):
        logger.warning(f"⚠️  fastq-dump 未找到 | not found")
