...
class PhyloTreeBuilder:
    ...
    def run_pipeline(self):
        ...
        try:
            ...
            # 2. 检测序列类型
            self.logger.info("步骤2/5: 检测序列类型|Step 2/5: Detecting sequence type")
            ...
            # 3. 清理序列和处理ID
            self.logger.info("步骤3/5: 清理序列和处理ID|Step 3/5: Cleaning sequences and processing IDs")
            ...
            # 4. 运行MAFFT多序列比对
            self.logger.info("步骤4/5: MAFFT多序列比对|Step 4/5: MAFFT multiple sequence alignment")
            ...
            # 5. 运行FastTree构建系统发育树
            self.logger.info("步骤5/5: FastTree构建系统发育树|Step 5/5: FastTree phylogenetic tree construction")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='系统发育树构建工具(模块化版本)|Phylogenetic Tree Builder Tool (Modular Version)',
