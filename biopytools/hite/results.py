...
class HiteResultsProcessor:
    ...
    处理HiTE单基因组分析的输出结果
    Process output results from HiTE single-genome analysis
    """
    ...
    def __init__(self, config, logger):
        ...
        Args:
            config: HiteConfig配置对象|HiteConfig object
    ...
    def process_results(self) -> Dict[str, str]:
        """
        处理HiTE输出结果|Process HiTE output results
        ...
        # 如果启用了注释，查找注释文件|If annotation enabled, find annotation files
        ...
        # 如果启用了结构域预测，查找结构域文件|If domain enabled, find domain file
    ...
    def generate_summary(self) -> Dict:
        ...
        summary_file = os.path.join(self.config.output_dir, 'hite_summary.json')
