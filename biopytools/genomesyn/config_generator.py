...
class ConfigGenerator:
    ...
    def save_config_generation_script(self, output_dir: str):
        ...
        with open(script_path, 'w') as f:
            ...
            f.write("echo \" 注意: 这需要原始的sample map文件|Note: This requires the original sample map file\"\n\n")
    ...
    def generate_default_config(self, samples: List[Dict], output_dir: str, config: 'GenomeSynConfig' = None) -> Tuple[str, str]:
        ...
        config_data = {
            ...
            "visualization": {
                ...
                "regions_file": config.regions_file if config else None
            }
        }
        ...
        for i in range(len(samples) - 1):
            link_data = {
                ...
                "params": {
                    "preset": "asm5",
                    "min_length": config.min_length if config else 5000,
                    "use_preset": config.use_minimap2_preset if config else True
                }
            }
