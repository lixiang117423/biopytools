...
class GenomeSynConfig:
    ...
    threads: int = 16
    min_length: int = 5000
    use_minimap2_preset: bool = True  # 是否使用minimap2的-x预设参数|Whether to use minimap2 -x preset
    
    # 可视化参数|Visualization parameters
    canvas_width: Optional[int] = None
    canvas_height: Optional[int] = None
    output_formats: List[str] = None
    regions_file: Optional[str] = None  # 区域标注文件|Special region annotation file
    ...
    def _get_default_aligner_params(self) -> Dict[str, Any]:
        ...
        default_params = {
            "minimap2": {
                ...
                "use_preset": self.use_minimap2_preset
            },
            "mummer": {
