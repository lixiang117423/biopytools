...
# --- 2. 输入/输出目录 ---
# 原始 FastQ 数据所在的目录
FASTQ_INPUT_DIR="${ANALYSIS_BASE}/01.data/clean/第一批" # 假设FastQ原始数据在这里
...
# --- 步骤 0.99: 测序数据过滤 (fastp) ---
log_info "📊 步骤 0.99: 运行测序数据过滤 (biopytools  fastp)..."

biopytools fastp \
    -i /share/org/YZWL/yzwl_lixg/project/21.野生大豆群体/01.data/raw/第一批 \
    -o /share/org/YZWL/yzwl_lixg/project/21.野生大豆群体/01.data/clean/第一批
...
# log_info "🔍 步骤 2: 运行联合变异检测 (biopytools gatk-joint)..."
...
# log_info "🧹 步骤 3: 运行变异过滤 (biopytools filter-snp-indel)..."
# # 定义输入VCF文件的完整路径
