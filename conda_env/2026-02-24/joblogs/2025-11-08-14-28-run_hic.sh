...
# --- 路径设置 ---
# 拟南芥基因组fasta文件绝对路径
GENOME_FA="/share/org/YZWL/yzwl_lixg/project/22.拟南芥hic/01.data/genome/genome.fa"
# Hi-C小试数据的原始fq.gz文件所在目录 (RawData目录)
RAW_DATA_DIR="/share/org/YZWL/yzwl_lixg/project/22.擬南芥hic/01.data/raw/F25A040009292_ARAjyxceD/ARAjyxceD_hic_test/RawData"
# 分析工作主目录 (脚本将在此目录下创建所有文件)
ANALYSIS_DIR="/share/org/YZWL/yzwl_lixg/project/22.拟南芥hic/02.小试"
...
# --- 环境设置 ---
# 安装了HiC-Pro的Conda环境名称
CONDA_ENV_NAME="hic-pro"
...
# # --- 激活 Conda 环境 ---
# echo "INFO: 正在激活Conda环境: ${CONDA_ENV_NAME}..."
# # 确保conda命令可用
