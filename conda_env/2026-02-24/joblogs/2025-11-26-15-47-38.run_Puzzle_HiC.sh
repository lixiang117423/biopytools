...
# 1. 输入文件 (请使用绝对路径)
REF_FASTA="~/project/06.longliuxing_BSA/68.三代数据组装和注释/05.allhic/OV53_1.primary.fa"              # 基因组 FASTA 文件
HIC_R1="~/project/06.longliuxing_BSA/68.三代数据组装和注释/04.YaHS/fastq/OV53_1-hic_R1.fastq.gz"        # Hi-C Read 1
HIC_R2="~/project/06.longliuxing_BSA/68.三代数据组装和注释/04.YaHS/fastq/OV53_1-hic_R2.fastq.gz"        # Hi-C Read 2
