...
# 1. 参考基因组文件路径
GENOME_FILE="/share/org/YZWL/yzwl_lixg/project/19.大豆疫霉菌/01.data/致病疫霉/GCF_000142945.1_ASM14294v1_genomic.fna"

# 2. 输出的 Reads 1 文件名
OUTPUT_R1="T30-4_1.clean.fq"

# 3. 输出的 Reads 2 文件名
OUTPUT_R2="T30-4_2.clean.fq"
