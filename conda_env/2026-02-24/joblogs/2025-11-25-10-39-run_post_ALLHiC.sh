...
# ============================ 1. 参数与路径配置 ============================
# 📂 输入文件路径
AGP_FILE="/share/org/YZWL/yzwl_lixg/project/06.longliuxing_BSA/68.三代数据组装和注释/05.allhic/groups.agp"
REF_FASTA="/share/org/YZWL/yzwl_lixg/project/06.longliuxing_BSA/68.三代数据组装和注释/05.allhic/groups.asm.fasta"
