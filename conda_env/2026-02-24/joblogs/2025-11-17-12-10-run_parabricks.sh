...
# --- 1. 项目基础路径 ---
PROJECT_BASE="/share/org/YZWL/yzwl_lixg/project/19.大豆疫霉菌/09.avr3a_blast"
ANALYSIS_BASE="${PROJECT_BASE}/parabricks"
...
# 本次分析的各个步骤目录
REF_GENOME_DIR="${ANALYSIS_BASE}" # 参考基因组所在的目录
...
REF_GENOME_FASTA="${REF_GENOME_DIR}/Avr3a-Ref-1.fa"
