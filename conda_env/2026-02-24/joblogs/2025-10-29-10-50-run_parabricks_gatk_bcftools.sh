...
# --- 2. 输入/输出目录 ---
# 原始 FastQ 数据所在的目录
FASTQ_INPUT_DIR="${ANALYSIS_BASE}/01.data/clean" # 假设FastQ原始数据在这里
...
echo "✨ Parabricks + GATK joint Calling的 SNP/INDEL 鉴定流程 ✨"
...
RAW_VCF="${GATK_DIR}/joint_genotyping_merged_filtered.vcf.gz"
