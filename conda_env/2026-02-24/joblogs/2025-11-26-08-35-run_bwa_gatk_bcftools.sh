...
bcftools view \
    -i 'MAF > 0.05' --threads 88 -Oz \
    -o 04.filtered_snp_indel/variation.filtered.snp.maf0_05.vcf.gz \
    04.filtered_snp_indel/variation.filtered.snp.vcf.gz

mkdir 02.mapping/04.bam_stat
