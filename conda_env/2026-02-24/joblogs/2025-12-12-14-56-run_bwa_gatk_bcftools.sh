...
# --- [1] 项目参数 ---
SPECIES="wanqusuimijie"       # 结果文件前缀 (例如: hancai, rice, soybean)
...
# Mapping 脚本路径
MAPPING_SCRIPT="${HOME}/software/scripts/32.运行BWA+GATK流程.sh"
# 统计脚本路径
BAM_STAT_SCRIPT="${HOME}/software/scripts/23.bam文件统计.py"
...
# 定义关键文件的【绝对路径】
REF_GENOME="${PROJECT_DIR}/01.data/genome/120.sorted.genome.fa"
...
# 检查联合变异结果
JOINT_VCF="${OUT_JOINT}/joint_genotyping_merged_filtered.vcf.gz"
if [ ! -f "${JOINT_VCF}" ]; then
