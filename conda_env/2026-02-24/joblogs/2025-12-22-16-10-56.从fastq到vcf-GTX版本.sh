...
# 1. 核心输入路径 (必须修改)
PROJECT_BASE="${PROJECT_BASE:-/share/org/YZWL/yzwl_lixg/project/06.longliuxing_BSA/68.三代数据组装和注释/31.重测序数据比对到挂载的结果上}"
RAW_FASTQ_DIR="${PROJECT_BASE}/01.data/raw"
REF_GENOME_FA="${PROJECT_BASE}/01.data/genome/OV53_1.primary_corrected.chr.fa"
...
run_variant_filtering() {
    local input_vcf="$1"
    # local input_vcf="${JOINT_DIR}/gtx_joint_raw.vcf.gz"
