...
# --- 1. 项目基础路径 ---
PROJECT_BASE="/share/org/YZWL/yzwl_lixg/project/06.longliuxing_BSA/68.三代数据组装和注释/"
ANALYSIS_BASE="${PROJECT_BASE}/25.primary作为参考基因组检测变异做GWAS"

# --- 2. 输入/输出目录 ---
# 原始 FastQ 数据所在的目录
FASTQ_INPUT_DIR="${ANALYSIS_BASE}/clean" # 假设FastQ原始数据在这里
...
REF_GENOME_FASTA="${REF_GENOME_DIR}/yahs_out_scaffolds_final.fa"
...
bwa index /share/org/YZWL/yzwl_lixg/project/06.longliuxing_BSA/68.三代数据组装和注释/25.primary作为参考基因组检测变异做GWAS/01.data/genome/yahs_out_scaffolds_final.fa
...
# 合并变异结果
# --- 用户需配置的变量 ---
REF_GENOME="/share/org/YZWL/yzwl_lixg/project/06.longliuxing_BSA/68.三代数据组装和注释/25.primary作为参考基因组检测变异做GWAS/01.data/genome/yahs_out_scaffolds_final.fa"
GVCF_DIR="/share/org/YZWL/yzwl_lixg/project/06.longliuxing_BSA/68.三代数据组装和注释/25.primary作为参考基因组检测变异做GWAS/02.mapping/vcf"
OUTPUT_DIR="/share/org/YZWL/yzwl_lixg/project/06.longliuxing_BSA/68.三代数据组装和注释/25.primary作为参考基因组检测变异做GWAS/03.glnexus_joint"
# !!! 关键：根据您的gVCF来源修改此配置 !!!
GLNEXUS_CONFIG="gatk" 
