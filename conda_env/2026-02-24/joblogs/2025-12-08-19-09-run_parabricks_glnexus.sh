...
ANALYSIS_BASE="${PROJECT_BASE}/24.单倍型1作为参考基因组检测变异做GWAS"
...
bwa index /share/org/YZWL/yzwl_lixg/project/06.longliuxing_BSA/68.三代数据组装和注释/24.单倍型1作为参考基因组检测变异做GWAS/01.data/genome/yahs_out_scaffolds_final.fa
...
# 合并变异结果
# --- 用户需配置的变量 ---
REF_GENOME="/share/org/YZWL/yzwl_lixg/project/06.longliuxing_BSA/68.三代数据组装和注释/24.单倍型1作为参考基因组检测变异做GWAS/01.data/genome/yahs_out_scaffolds_final.fa"
GVCF_DIR="/share/org/YZWL/yzwl_lixg/project/06.longliuxing_BSA/68.三代数据组装和注释/24.单倍型1作为参考基因组检测变异做GWAS/02.mapping/vcf"
OUTPUT_DIR="/share/org/YZWL/yzwl_lixg/project/06.longliuxing_BSA/68.三代数据组装和注释/24.单倍型1作为参考基因组检测变异做GWAS/03.glnexus_joint"
# !!! 关键：根据您的gVCF来源修改此配置 !!!
GLNEXUS_CONFIG="gatk" 
